                ...
                for (int i = 0; i < 5; i++)
                {
                    ...
                    switch (i)
                    {
                        ...
                        case 3:
                            ...
                            //Console.WriteLine(text);
                            if (text[0].ToString() + text[1].ToString() == "YE" || text[0].ToString().Contains("Y") || text[1].ToString().Contains("Y"))
                            {
                        ...
                        case 4:
                            ...
                            //Console.WriteLine(text);
                            if (text[0].ToString() + text[1].ToString() == "YE" || text[0].ToString().Contains("Y") || text[1].ToString().Contains("Y") || text[0].ToString().Contains("E")
                                || text[1].ToString().Contains("E"))
                            {
